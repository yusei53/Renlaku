  ...
  return (
    <Container>
      ...
      <ServiceCard
        ...
        secondTitle={"テンプレート"}
        content={
          "大学生が遭遇する様々なシチュエーションに対応するメールテンプレートを提供しています。大学の授業やアルバイトの欠席連絡、内定の取消しをはじめ、大学生活に必要不可欠なテンプレートを用意しています。学生のニーズは時代と共に変化します。そのため、ユーザーからのリアルタイムフィードバックに基づき、テンプレートのラインナップを継続的に更新し、柔軟に対応していきます。"
        }
        image={"/mail.png"}
        alt={"豊富なテンプレート"}
      />
